...
import ua.steniuk.myapplication.ui.shared.components.AnimatedSwipeDismiss
    ...
    Box(
        ...
        Card(
            ...
            Box(modifier = Modifier.padding(16.dp)) {
                Row(modifier = Modifier.fillMaxWidth()) {
                    Column(horizontalAlignment = Alignment.Start) {
                        // ЗМІНЕНО: тепер бере шрифт з налаштувань bodyLarge (Audiowide)
                        Text(
                            text = timezone,
                    ...
                    Spacer(modifier = Modifier.weight(1.0f))
                    Column(horizontalAlignment = Alignment.End) {
                        // ЗМІНЕНО: тепер бере шрифт з теми
                        Text(
                            text = time,
